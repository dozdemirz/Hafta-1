...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Yolculuk tipinizi seçiniz 1/2? 1: Tek yön, 2: Gidiş dönüş");
        ...
        if (yas > 0 && yas < 12) {
            ...
            System.out.println("İndirimli tutarınız:" + fiyat);
        ...
        switch (yolculuktipi) {
            ...
            case 2:
                ...
                System.out.println("Toplam fiyatınız: " + fiyat1);
                break;
            default:
                System.out.println("Hatalı giriş yaptınız.");
